...
export class DetailProductComponent implements OnInit{
  ...
  constructor(private homeService:HomeService, private activateRoute:ActivatedRoute, private cartService:CartService, private toastr: ToastrService){
  ...
  addCart(id : number){
    ...
    this.toastr.success('Prodcuto añadido correctamente', 'Carrito compras');
